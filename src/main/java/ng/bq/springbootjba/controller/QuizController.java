...
//    @PreAuthorize("isAuthenticated()")
    ...
    public Quiz save(User user, @Valid Quiz quiz, BindingResult result) {
...
//    @PreAuthorize("permitAll")
    @ResponseStatus(HttpStatus.OK)
    public Result playQuiz(@PathVariable long quiz_id, @RequestBody List<Reponse> answersBundle) {
        Quiz quiz = quizService.find(quiz_id);
